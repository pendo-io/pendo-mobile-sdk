...
>[!NOTE]
>**Expo SDK** 41-48 using React Native Navigation 6+ is supported. See dedicated installation [Expo integration instructions](/android-integration/expo_rnn-android.md).
