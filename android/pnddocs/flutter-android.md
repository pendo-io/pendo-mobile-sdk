...
>[!IMPORTANT]
>Flutter low-code solution is currently in OPEN BETA.<br><br>
Upgrading from track-event only solution to the low-code solution will take 24 hours to register in Pendo's systems. During this time period the Pendo UI low-code features and tagging won't be available.
