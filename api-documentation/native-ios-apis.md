...
>To use secure metadata sessions a Pendo official must enable this feature.
...
>To support SwiftUI you must apply this modifier to the application rootView. In case of multiple rootViews (ex. usage of multiple UIHostingControllers), apply the modifier to each main rootView.
