...
Common in apps mid-migration to Compose. When hybrid, both wiring paths apply — the Views portions track automatically, and the Compose portions follow the same optional/conditional rules as Compose-only above.
